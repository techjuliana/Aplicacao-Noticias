      ...
      <Container>
        <Link to={`/detalhes`}>
          <Postagens
            ...
            subtitulo2={
              "Examinando as dicas e truques usados ​​para tornar o design do site da Stripe um degrau acima do resto."
            }
            data3={"04 de março de 2021"}
            titulo3={
              "Passado, presente e futuro do gerenciamento de estado React"
            }
            subtitulo3={
              "Conheça a história do gerenciamento de estado no React e quais são as soluções preferidas hoje."
            }
            data4={"03 de março de 2021"}
            titulo4={"Criando um Monorepo com espaços de trabalho Lerna & Yarn"}
            subtitulo4={
              "Neste guia, você aprenderá como criar um Monorepo para gerenciar vários pacotes com um processo compartilhado de compilação, teste e lançamento."
            }
          />
        </Link>
      </Container>
